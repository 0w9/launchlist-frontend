export default function Home() {
  return (
    <main class="space-y-12 md:space-y-24 px-4">
      <section class="flex flex-col md:flex-row gap-24 md:pt-24">
        <div class="relative px-6 lg:px-8">
          ...
          <a class="bg-blue-400 hover:bg-blue-500 text-gray-800 font-bold py-2 px-4 mt-8 flex gap -x-4 sm:justify-center rounded inline-flex items-center" href="https://lennardships.gumroad.com/l/launch">
            Get the list
